...
def resnet18(pretrained_path=None):
    """Constructs a ResNet-18 deploy_model.
    Args:
        pretrained (bool): If True, returns a deploy_model pre-trained on ImageNet
    """
...
def resnet34(pretrained_path=None, **kwargs):
    """Constructs a ResNet-34 deploy_model.
    Args:
        pretrained (bool): If True, returns a deploy_model pre-trained on ImageNet
    """
...
def resnet50(pretrained_path=None, **kwargs):
    """Constructs a ResNet-50 deploy_model.
    Args:
        pretrained (bool): If True, returns a deploy_model pre-trained on ImageNet
    """
...
def resnet101(pretrained_path=None, **kwargs):
    """Constructs a ResNet-101 deploy_model.
    Args:
        pretrained (bool): If True, returns a deploy_model pre-trained on ImageNet
    """
