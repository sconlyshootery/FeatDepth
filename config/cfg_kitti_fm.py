...
data = dict(
    ...
    width = WIDTH,
    frame_ids = FRAME_IDS,
    in_path = '/media/sconly/24eda5d5-e79b-423b-8dcc-8339a15f3219/data/kitti/kitti_raw/rawdata',#path to raw data
    gt_depth_path = '/media/sconly/24eda5d5-e79b-423b-8dcc-8339a15f3219/data/kitti/kitti_raw/rawdata/gt_depths.npz',#path to gt data
...
model = dict(
    ...
    depth_pretrained_path = '/media/sconly/24eda5d5-e79b-423b-8dcc-8339a15f3219/weight/resnet/resnet{}.pth'.format(DEPTH_LAYERS),# pretrained weights for resnet
    pose_pretrained_path =  '/media/sconly/24eda5d5-e79b-423b-8dcc-8339a15f3219/weight/resnet/resnet{}.pth'.format(POSE_LAYERS),# pretrained weights for resnet
    extractor_pretrained_path = '/media/sconly/24eda5d5-e79b-423b-8dcc-8339a15f3219/weight/autoencoder.pth',# pretrained weights for autoencoder
