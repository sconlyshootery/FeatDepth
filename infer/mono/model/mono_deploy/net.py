...
class MonoDeploy(nn.Module):
    def __init__(self, options):
        super(MonoDeploy, self).__init__()
        self.opt = options
        ...
        self.ssim = SSIM()
        self.backproject_depth = BackprojectDepth(self.opt.imgs_per_gpu, self.opt.height, self.opt.width)
        self.project_3d = Project3D(self.opt.imgs_per_gpu, self.opt.height, self.opt.width)
